...
Different methods for identifying causality with observational data - difference-in-differences, regression discontinuity, and instrumental variables. Today we'll focus on diff-in-diff.
...
Given the temporal dimension of this experiment, let's estimate a differences-in-differences estimator using `re75` to represent participants' earnings before the intervention and `re78` to represent earnings after the intervention. Under what assumptions does this estimator identify a causal effect? Recall:
